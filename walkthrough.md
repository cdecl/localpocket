...
5. **스크린샷 리사이즈 및 생성 (`images/screenshot*.png`)**:
   - `images/image.png`의 팝업 창 영역을 픽셀 단위로 정밀 크롭(1140×1160, 2x Retina 해상도)하여 `screenshot.png` 생성.
   - `./generate-screenshots.sh`를 실행하여 크롬 웹스토어용 프로모션 규격 타일 이미지(`screenshot-440x280.png`, `screenshot-640x400.png`) 각각 생성 완료.
